                ...
                <td class="btn-actions">
                    <div class="d-flex">
                        ...
                        <button type="button" class="btn btn-success btn-sm mx-2">
                            <a class="text-decoration-none text-white" href="{{route('admin_read_page', ['id' => $tome->id]) }}" data-toggle="tooltip" data-placement="bottom" title="Voir les pages"><i class="fa fa-eye white"></i></a>
                        </button>
