...
<head>
    ...
    <link rel="stylesheet" href="<?php base_path('/assets/css/reset.css')?> ">
    <link rel="stylesheet" href="<?php base_path('/assets/css/style.css')?>">
    <link rel="stylesheet" href="<?php base_path('/assets/css/menu.css')?>">
</head>
