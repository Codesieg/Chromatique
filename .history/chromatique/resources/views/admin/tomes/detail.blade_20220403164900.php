...
<div class="container">
    ...
    <div class="d-flex justify-content-space-between mb-3 px-3">
        <div class="add">
            <button type="button" class="btn btn-primary btn-sm white"><a href=""><i class="fa fa-arrow-alt-to-left white"></i></a></button>
                ...
                <td class="btn-actions">
                    <div class="d-flex">
                        <button type="button" class="btn btn-success btn-sm text-decoration-none text-white">
                            <a class="text-decoration-none text-white" href="{{route('admin_edit_tome', ['id' => $tome->id]) }}" data-toggle="tooltip" data-placement="bottom" title="Modifier le manga"><i class="fa fa-edit white"></i></a>
                        </button>
                        <button type="button" class="btn btn-success btn-sm text-decoration-none text-white">
