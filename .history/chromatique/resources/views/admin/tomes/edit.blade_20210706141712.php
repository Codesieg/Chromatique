...
<div class="container">
  <div class="row">
  <h3 class="col-8 text-white">Modification d'un Tome</h3>
  <form method="patch" action="{{route('admin_add_tome')}}" enctype="multipart/form-data" class="col-8 align-self-center">
    {{csrf_field()}}
      <div class="">
        ...
        <input type="file" name="tomePath" class="myfrm form-control"  value="{{ $tome->tome_number }}">
      </div>
      ...
      <div class="form-group" >
        ...
        <input class="form-control" type="text" name="tomeNumber" id="tomeNumber" value="{{ $tome->tome_path }}">
      </div>
