        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-success btn-xs text-decoration-none text-white">
                        <a class="text-decoration-none text-white" href="{{route('admin_form_tome', ['id' => $tome->id]) }}">Voir Tome</a>
                    </button>
