...
<div class="container">
    <div class="menu_admin">
        <div class="add">
            <button type="button" class="btn btn-primary btn-sm"><a class="text-decoration-none text-white" href="{{route('admin_form_tome')}}">Ajouter Manga</a></button>
        </div>
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-success btn-sm text-decoration-none text-white">
                        <a class="text-decoration-none text-white" href="{{route('admin_form_tome', ['id' => $tome->id]) }}">Ajouter Tome</a>
                    </button>
