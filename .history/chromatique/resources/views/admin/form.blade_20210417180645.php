...
<div class="container ">
  <div class="col">
  <h3 class="well text-white">Ajout d'un nouveau Tome</h3>
  <form method="post" action="{{route('admin_add_manga')}}" enctype="multipart/form-data" class="col-8 row align-items-center">
    {{csrf_field()}}
      <div class="">
