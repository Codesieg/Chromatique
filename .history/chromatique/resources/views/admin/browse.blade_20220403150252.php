...
<div class="container">
    <div class="row">
        <div class="col align-self-end white">
            <button type="button" class="btn btn-primary btn-sm"><a class="text-decoration-none text-white" href="{{route('admin_form_manga')}}"><i class="fa fa-square-plus"></i></a></button>
        </div>      
    </div>
    <div class="col-12">
        <table class="table">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-success btn-sm text-decoration-none text-white">
                        <a class="text-decoration-none text-white"  href="{{route('admin_form_edit_manga', ['id' => $manga->id]) }}">Modifier</a>
                    </button>
