...
<div class="container">
    <div class="row">
        <button type="button" class="btn btn-primary btn-sm align-self-end white"><a class="text-decoration-none text-white" href="{{route('admin_form_manga')}}"><i class="fa plus-square white"></i></a></button>    
    </div>
    <div class="col-12">
        <table class="table">
            <thead>
