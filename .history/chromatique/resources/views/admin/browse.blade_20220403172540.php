...
<div class="container">
    ...
    <div class="d-flex justify-content-between mb-3 px-3">
        <button type="button" class="btn btn-orange btn-sm white"><a href="{{route('browse_mangas')}}"><i class="fa fa-angle-double-left white"></i></a></button>
        <button type="button" class="btn btn-orange btn-sm white"><a href="{{route('admin_form_manga')}}"><i class="fa fa-plus-square white"></i></a></button>    
    </div>
    <div class="col-12">
        <table class="table">
            <thead>
