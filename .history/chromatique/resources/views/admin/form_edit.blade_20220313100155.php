...
<div class="container">
  <div class="row">
    ...
    <form method="post" action="{{route('admin_edit_manga')}}" enctype="multipart/form-data" class="col-8 align-self-center">
      {{csrf_field()}}
        <div class="">
          <img src="<?= asset('storage/mangas/') ?>{{$manga->manga_directory .'/'. $manga->manga_cover }}" alt="{{$manga->manga_cover}}">
        ...
        <div class="">
          <img src="<?= asset('storage/mangas/') ?>{{$manga->manga_directory .'/'. $manga->manga_banner }}" alt="{{$manga->manga_banner}}">
        ...
        <div class="form-group" >
          ...
          <input class="form-control" type="text" name="synopsis" id="synopsis" value="{{$manga->manga_synopsis}}">
        </div>
        <?= dd($manga) ?>
        {{-- <div class="form-group" >
