...
class PagesController extends Controller
{
    ...
    public function delete($id)
    {
        ...
        $pageDirectory = public_path() . '/assets/pages/' .  $page->page_directory;
        ...
        if ($page) {
            ...
            if (File::exists($pageDirectory)) {
                ...
                return back()->with('error', 'Le dossier pour le page  ' . $page->page_name . ' n\'éxiste pas !', 404);
            }
            ...
            return back()->with('success', 'Le page ' . $page->page_name . ' à bien était supprimé !', 200);
        } else {
            // Je retourne un message d'erreur
            return back()->with('error', 'Le page ' . $page->page_name . ' n\'éxiste pas !', 404);
        }
    }
}
