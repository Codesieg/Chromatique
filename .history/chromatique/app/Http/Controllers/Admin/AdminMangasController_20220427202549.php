    ...
    public function add(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            if($request->hasfile('mangaCover'))
            {
                ...
                $bannerName = $formatBanner . '.' . $request->file('mangaCover')->extension();

                $mangaBanner = Storage::disk('mangas')->putFileAs($formatBanner, $request->file('mangaBanner'), $bannerName . '_banner');
