...
class AdminTomesController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        // dd($mangaDirectory[0]->manga_directory);
        ...
        //     {
                ...
                $cover = Storage::disk('mangas')->makeDirectory($mangaDirectory[0]->manga_directory . $tomeName);
                // $cover = Storage::disk('mangas')->makeDirectory($mangaDirectory[0]->manga_directory, $cover, $tomeName);
                dd($cover);
