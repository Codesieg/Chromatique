...
class AdminPagesController extends Controller
{
    ...
    {
        $tomeNumber = Tomes::find($id);
        $listPagees = Pages::where('tomes_id', $id)->orderBy('page_file')->get();
        $mangaName = Mangas::find($tomeNumber->manga_id);

        return view('admin/tomes/detail', compact('listPagees', 'mangaName', 'tomeNumber'));
    }
