...
class AdminTomesController extends Controller
{
     ...
     * @return App\Models\Tomes
     */
    public static function insert($newTome, $lastMangaId)
    {
        $tomeToAdd = Storage::disk('local')->allFiles('public/mangas/' . $newTome);
        dd($tomeToAdd);
        // is_dir($file) est un dossier ?
        $tomeNumber = $tomeToAdd;
