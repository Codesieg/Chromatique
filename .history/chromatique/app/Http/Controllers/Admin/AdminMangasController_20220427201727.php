    ...
    public function add(Request $request)
    {
        ...
        $this->validate($request, [
            ...
            if($request->hasfile('mangaCover'))
            {
                ...
                $cover = Storage::disk('mangas');
                // Storage::putFileAS($formatName, $request->file('mangaCover'), $coverName);
                $test = $request->file('mangaCover')->getRealPath();
                // dd($cover);
            
                $file = Storage::disk('mangas')->putFileAs($formatName, $request->file('mangaCover'), $coverName);
