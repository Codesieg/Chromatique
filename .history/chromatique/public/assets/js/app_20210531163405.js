...
const app = {
    ...
    init: function() {
        ...
        closeElement.addEventListener("click", app.closeFlash(closeElement));
    ...
    closeFlash: function(closeElement) {
        closeElement.classList.add("fade-flash");
        console.log("element " + closeElement);
    }
