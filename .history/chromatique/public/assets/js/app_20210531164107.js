...
const app = {
    ...
    init: function() {
        ...
        let closeElement = document.querySelector(".lose");
        closeElement.addEventListener("click", app.closeFlash());
    ...
    closeFlash: function() {
        const flashElement = document.querySelectorAll(".alert");
        flashElement.classList.add("fade-flash");
